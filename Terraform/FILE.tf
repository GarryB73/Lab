...
#
resource "vsphere_virtual_machine" "FIL" {
  name                 = "${var.FIL_name}"
  num_cpus             = "${var.FIL_cpu_num}"
  memory               = "${var.FIL_mem}"
